    ...
    return (
        <div className="flex flex-col items-center gap-2">
            ...
            >
                ...
                {/* Card count badge */}
                <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gray-800 border-2 border-amber-500/60 flex items-center justify-center text-sm font-bold text-amber-400">
                    {count}
                </div>
