      ...
      {isJoker ? (
        ...
        <>
          ...
          <div className="absolute top-1 left-1.5 flex flex-col items-center leading-none">
            <span className="text-xs font-bold" style={{ color: suitColor }}>{rank}</span>
            <span className="text-sm -mt-0.5" style={{ color: suitColor }}>{suit}</span>
          </div>
          {/* Center suit */}
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-2xl" style={{ color: suitColor }}>{suit}</span>
          </div>
    ...
    <div className="flex flex-col gap-8">
      ...
      <div>
        <div className="flex gap-12 mb-3">
          <span className="text-xs text-white/60 uppercase tracking-wider w-14 text-center">Primary</span>
          <span className="text-xs text-white/60 uppercase tracking-wider w-14 text-center">Secondary</span>
          <span className="text-xs text-white/60 uppercase tracking-wider w-14 text-center">Neutral</span>
        </div>
        {/* Row 1 */}
        <div className="flex gap-12 mb-3">
      ...
      <div>
        ...
        <div className="flex gap-6 justify-center">
          <FaceUpCard 
            rank="6" 
            suit="♠" 
            suitColor={theme.primary.solid} 
            delay={0.3}
          />
          <FaceUpCard 
            rank="7" 
            suit="♥" 
            suitColor={theme.secondary.solid} 
            delay={0.4}
          />
          <FaceUpCard 
            rank="" 
